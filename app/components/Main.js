...
const Main = () => {
    return(
        <div className="m-2 ">
            <div className="w-44">
                <Image className="mt-4 ml-4" src={logo} width={100} height={100} alt="logo"/>
            </div>
            <div className="flex w-full">
                <div>
                    <div className="ml-8 mb-6">
                        ...
                        <div>
                            <Image className="absolute -z-10 ml-72 -mt-52 md:hidden opacity-30" src={themebg} width={360} height={780} alt="themebg"/>
                        </div>
                    ...
                    <div className="m-6 mb-0 flex flex-col space-y-4">
                        <div>
                            <h2 className="text-xl text-center xl:text-left xl:ml-64 lg:text-2xl mt-4 mb-5 font-medium tracking-wider">We are open for orders through...</h2>
                        </div>
                        <div className="flex flex-col lg:flex-row space-y-3 lg:space-y-0">
                            <div className="flex ml-4 space-x-4 lg:space-x-2 xl:text-xl">
                                <div>
                                    <h3 className="text-yellow-400">Order through WhatsApp or Call :</h3>
                                </div>
                                <div>
                            ...
                            <div className="ml-44 sm:ml-44 lg:ml-10 flex space-x-4 xl:text-xl">
                                <div>
                                    <h3 className="text-yellow-400">Mail us at :</h3>
                                </div>
                                <div>
                ...
                <div className="-mt-24 mr-10 md:mr-8 2xl:mr-36">
                    <Theme />
                </div>
            </div>
            <div className="m-8 mt-0 flex flex-col ">
                ...
                {/* blank img  for medium screen and above */}
